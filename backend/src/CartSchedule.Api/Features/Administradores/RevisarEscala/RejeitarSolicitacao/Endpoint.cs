...
/// <summary>
/// Rejeita uma Solicitacao pendente. Nunca verifica/bloqueia o limite de 2 por trinca
        ...
        int id, AppDbContext db)
    {
        ...
        if (solicitacao.Status != StatusSolicitacao.Pendente)
        {
            return TypedResults.Problem(
                detail: $"Solicitação #{id} já foi decidida (status atual: {solicitacao.Status}) e não pode ser rejeitada novamente.",
