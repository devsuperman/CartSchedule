...
| F7-FE-03 | `wizard/*` | Ordem das etapas: nome → **carrinho** → dia → turno. Só aparecem carrinhos com algum turno configurado; dias sem turno no carrinho escolhido ficam desabilitados; trocar o carrinho limpa dia/turno incompatíveis. |
